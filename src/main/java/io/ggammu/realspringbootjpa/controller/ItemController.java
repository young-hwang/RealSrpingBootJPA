...
public class ItemController {
    ...
    public String update(@PathVariable Long itemId, @ModelAttribute("item") BookForm bookForm) {
        itemService.saveUpdateItem(itemId, bookForm.getName(), bookForm.getPrice(), bookForm.getStockQuantity());
